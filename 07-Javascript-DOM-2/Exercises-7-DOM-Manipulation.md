...
Build a dynamic dashboard. When the user types in the search box or changes the dropdown, the list of drones shown on the screen should instantly update to match the filters.
